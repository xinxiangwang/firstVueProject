<template>
 <div class="tmpl">
   ...
   <div class="photo-title">
     <p v-show="isShow">图片标题：{{ imgInfo.title }}</p>
     <span v-show="isShow">发起日期：{{ imgInfo.add_time }}</span>
     <span v-show="isShow">{{ imgInfo.click }}次浏览</span>
     <span v-show="isShow">分类：{{ imgInfo.category }}</span>
   </div>
